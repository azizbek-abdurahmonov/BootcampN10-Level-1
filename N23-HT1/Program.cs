...
var sortedProducts = products.OrderByDescending(product => product.Stars).ThenByDescending(product => product.Inventory).Take(5);
sortedProducts.ToList().ForEach(Console.WriteLine);
